...
class ExplositionGallery {
    ...
    initModal() {
        ...
        this.modalContainerNode.innerHTML = `
            ...
            <div class="${explosionImagesClassName}">
                ...
                data-description="${linkNode.dataset.description}"/>`).join('')}
            </div>
        `;
        ...
        this.explosionCaunterNode = this.modalContainerNode.querySelector(`.${explosionCouterClassName}`);
    ...
    events() {
        ...
        this.containerNode.addEventListener('click', this.activeteGallery);
        this.explosionNavNode.addEventListener('click', this.switchImage);
    ...
    closeGallery = () => {
        ...
        this.explosionSummaryNode.style.opacity = 1;
    ...
    changeCounter() {
        this.explosionCaunterNode.innerText = `${this.currentIndex + 1}/${this.size}`;
    }
